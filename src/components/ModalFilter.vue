...
<template>
  <!-- Modal toggle -->
  <button type="button" @click="handleModal(true)"
    class="text-[#0099AD] bg-white border border-[#0099AD] hover:bg-[#9ddee7] focus:ring-2 focus:ring-[#9ddee7] font-medium rounded-lg text-sm ml-4 p-3 flex justify-center items-center focus:outline-none">
      ...
      <div class="relative bg-white rounded-lg shadow">
        <div class="px-6 py-6 lg:px-8">
          <div class="flex">
            ...
            <h5 class="mb-4 text-lg font-medium text-gray-900"> Filter </h5>
          </div>
        ...
        <div class="flex justify-end px-6 py-4 lg:px-8">
          <div class="flex items-start">
            <button @click="handleModal(false)"
              class="w-full text-[#0099AD] bg-white border-2 border-[#80C1CD] hover:bg-[#80C1CD] focus:ring-2 focus:outline-none focus:ring-[#0099AD] font-medium rounded-lg text-xs mr-2 px-5 py-2.5 text-center">
              Batal
            </button>
            <button @click="submitFilter" type="submit"
              class="w-full text-white bg-[#0099AD] hover:bg-[#005A66] focus:ring-2 focus:outline-none focus:ring-[#80C1CD] font-medium rounded-lg text-xs px-5 py-3 text-center">
              Terapkan
            </button>
          </div>
        </div>

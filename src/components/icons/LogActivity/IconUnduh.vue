<template>
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M14 3V7C14 7.26522 14.1054 7.51957 14.2929 7.70711C14.4804 7.89464 14.7348 8 15 8H19" stroke="#333333"
    ...
    <path d="M9.5 14.5L12 17L14.5 14.5" stroke="#333333" stroke-width="1.33333" stroke-linecap="round"

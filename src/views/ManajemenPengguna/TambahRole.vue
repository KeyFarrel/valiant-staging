  ...
  <div class="bg-white px-6 rounded-lg h-full flex flex-col p-6">
    <form>
      <div class="flex flex-col w-full h-auto">
        <h2 class="border-l-8 border-[#0099AD] text-lg font-semibold text-primaryTextColor pl-2">
          Role
        </h2>
        <div class="flex mt-4 items-center">
          <p class="text-gray-600 font-semibold">Role</p>
          <input id="role" v-model="formData.role" type="text" placeholder="Masukan Nama Role"
            class="ml-28 w-full rounded-lg border-2 border-[#E0E0E0] text-primaryTextColor placeholder-[#E0E0E0]" />
        </div>
        <div class="flex mt-4 items-center">
          <p class="text-gray-600 font-semibold">Status</p>
          <label class="ml-28 relative inline-flex items-center mr-5 cursor-pointer">
            <input type="checkbox" class="sr-only peer" @change="handleStatusChange" />
            <div
      ...
      <div class="flex flex-col w-full h-auto mt-6">
        ...
        <div class="mt-6 flex">
          <table class="w-full text-sm text-left text-gray-500 rounded overflow-hidden">
            ...
            <tbody class="overflow-y-auto text-gray-900 text-xs">
              <tr v-for="(item, index) in comboSubmenu" :key="item.id_sub_menu" class="border">
                <th scope="row" class="px-3 py-3 font-medium whitespace-nowrap rounded-bl">
                  {{ index + 1 }}
                </th>
                <td class="px-6 py-3">
                  {{ item.sub_menu }}
                ...
                <td class="px-6 py-3">
                  <label class="relative inline-flex items-center mr-5 cursor-pointer">
                    <input type="checkbox" class="sr-only peer" v-model="item.create" />
                    <div
                      class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-[#9de5a8] dark:peer-focus:ring-[#21CD3C] dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-[#21CD3C]">
                    </div>
                  </label>
                ...
                <td class="px-6 py-3">
                  <label class="relative inline-flex items-center mr-5 cursor-pointer">
                    <input type="checkbox" class="sr-only peer" v-model="item.read" />
                    <div
                      class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-[#9de5a8] dark:peer-focus:ring-[#21CD3C] dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-[#21CD3C]">
                    </div>
                  </label>
                ...
                <td class="px-6 py-3">
                  <label class="relative inline-flex items-center mr-5 cursor-pointer">
                    <input type="checkbox" class="sr-only peer" v-model="item.update" />
                    <div
                      class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-[#9de5a8] dark:peer-focus:ring-[#21CD3C] dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-[#21CD3C]">
                    </div>
                  </label>
                ...
                <td class="px-6 py-3">
                  <label class="relative inline-flex items-center mr-5 cursor-pointer">
                    <input type="checkbox" class="sr-only peer" v-model="item.delete" />
                    <div
                      class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-[#9de5a8] dark:peer-focus:ring-[#21CD3C] dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-[#21CD3C]">
                    </div>
                  </label>
        ...
        <div class="h-5"></div>
        <nav class="mb-10 bg-white flex items-center justify-between pl-4 pr-4 pb-4 rounded-b-lg"

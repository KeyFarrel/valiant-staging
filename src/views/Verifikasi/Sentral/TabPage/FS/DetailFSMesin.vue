<template>
  ...
  <InfoHeader v-if="mesinDataById && approveSentralFS" :nama-mesin="mesinDataById.mesin ? mesinDataById.mesin : '-'"
    ...
    :umur-teknis="mesinDataById.masa_manfaat">

    <div class="flex" v-if="approveMesinFS">
      <div v-if="approveMesinFS.status === 'Ditolak T1' || approveMesinFS.status === 'Ditolak T2'" class="flex">
        <!-- Revisi Data -->
        <RouterLink :to="{ name: 'input-asumsi-parameter-approveFS', params: { id: approveMesinFS.id_mesin } }">
  ...
  <div class="items-start p-6 mt-4 bg-white rounded-lg">
    ...
    <TabsWrapper v-if="hasilSimulasi && mesinDataById && approveSentralFS" :isLihatGrafik="true" :laman-data="false"
      ...
      :tahun="tahunData ? tahunData : '-'" :irr-on-project="hasilSimulasi.now_fs_irr_project"
      ...
      :average-eaf="hasilSimulasi.now_track_average_eaf" :nama-mesin="mesinDataById.mesin ? mesinDataById.mesin : '-'"

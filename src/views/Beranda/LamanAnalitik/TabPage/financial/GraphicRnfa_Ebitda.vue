...
import type { BaseResponse, ResEbitda } from "@/views/Beranda/LamanAnalitik/TypeFinansial";
...
<template>
  <div class="flex flex-col h-full px-6 pt-4 pb-4 mt-4 bg-white rounded-lg">
    ...
    <!-- <FilteredChips ref="filterChips" v-model="value" @remove="getDataGraph" /> -->
    <div class="flex">
      <div
    ...
    <div v-else>
      <DynamicScatterPlot v-if="!graphData.isEmpty" :source="graphData.source" :series="graphData.series"
        ...
        :xData="{ name: 'EBITDA MARGIN', satuan: '%' }" :yData="{ name: 'RNFA', satuan: '%' }"

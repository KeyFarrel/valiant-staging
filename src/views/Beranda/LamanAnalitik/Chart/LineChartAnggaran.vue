...
<template>
  <div class="flex flex-col h-full px-6 pt-4 pb-4 mt-4 bg-white rounded-lg">
    ...
    <div class="flex pb-2">
      <h4 class="pl-2 font-semibold text-black">GAP</h4>
    </div>
    <div class="flex gap-x-4 gap-y-2">
      <div class="w-1/2">
        <div class="border border-opacity-25 rounded-lg border-[#7F7F80]">
          <div class="flex m-4">
            <h5 class="font-semibold text-black">CAPEX</h5>
            <a href="" class="text-[#0099AD] font-semibold ml-auto">Lihat Detail</a>
          </div>
          <div class="flex items-center m-4">
            <span class="w-2 h-2 bg-green-500 rounded-full"></span>
            <span class="text-[#0099AD] ml-2 align-middle leading-none text-xl font-semibold">9</span>
      ...
      <div class="w-1/2">
        <div class="border border-opacity-25 rounded-lg border-[#7F7F80]">
          <div class="flex m-4">
            <h5 class="font-semibold text-black">OPEX</h5>
            <a href="" class="text-[#0099AD] font-semibold ml-auto">Lihat Detail</a>
          </div>
          <div class="flex items-center m-4">

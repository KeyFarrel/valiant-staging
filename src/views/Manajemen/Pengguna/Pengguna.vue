<template>
    ...
    <TableComponent>
      <template v-slot:table-header>
        <tr>
          ...
          <th scope="col" class="text-center">Kunci Akun</th>
      ...
      <template v-slot:table-body v-else>
        <tr v-for="(user, index) in pengguna" :key="user.id">
          ...
          <td>
            <div class="flex items-center justify-center">
              <div v-if="user.is_locked == true"
                class="px-1.5 py-1 w-fit rounded-xl border border-[#EFC0BD] bg-[#FAEBEA] text-center flex justify-center space-x-1 items-center">
                <p class="text-[#C53830] font-semibold">Terkunci</p>
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0,0,256,256"
                  width="16px" height="16px" fill-rule="nonzero">
                  <g fill="#c53830" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt"
              ...
              <div v-else
                class="px-1.5 py-1 border border-[#C7E5D7] w-fit rounded-xl space-x-1 bg-[#E2FCF3] text-center flex justify-center items-center">
                <p class="text-[#397E5D] font-semibold">Tidak Terkunci</p>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink">
                  <rect width="16" height="16" fill="url(#pattern0_1801_9)" />
                  <defs>
                    <pattern id="pattern0_1801_9" patternContentUnits="objectBoundingBox" width="1" height="1">
                      <use xlink:href="#image0_1801_9" transform="scale(0.01)" />
                    </pattern>
                    <image id="image0_1801_9" width="100" height="100"
                      xlink:href="data:image/png;base64," />
                  </defs>
                </svg>
              </div>
            </div>
  ...
  <ModalWrapper :show-modal="isModalEdit" :width="'w-[800px]'" :height="'h-auto'">
    ...
    <form class="mt-4 space-y-4">
      ...
      <hr>
      <div class="flex flex-col space-y-1.5">
        <p class="text-sm text-warningColor">Lupa Password?</p>
        <button @click="isConfirmResetShow = true" type="button"
          class="px-3 py-2 text-sm font-semibold duration-300 border rounded-lg hover:bg-warningColor active:duration-0 active:ring active:ring-warningColor active:ring-opacity-50 hover:text-white border-warningColor text-warningColor w-fit">Reset
          Password</button>
      </div>
      <div class="flex justify-end mt-4 space-x-2">
        <button type="button"
...
const isResetPasswordSucces = ref<boolean>(false);
...
const resetPassword = async () => {
  try {
    if (resetPasswordVal.value.emailConfirm) {
      isConfirmResetShow.value = false;
      isLoading.value = true;
      await userService.resetPassword(resetPasswordVal.value.emailConfirm, resetPasswordVal.value.emailReset);
      isLoading.value = false;
      isModalEdit.value = false;
      isResetPasswordSucces.value = true;
      await wait(3000);
      isResetPasswordSucces.value = false;
      resetPasswordVal.value.emailConfirm = '';
      await fetchData();
    } else {
      notifyError('Email konfirmasi tidak boleh kosong', 5000);
    }
  } catch (error) {
...
const handleChangeLevel = (levelId: any) => {
  console.log(levelId);
  // Level Id 1 = Admin
  if (levelId == 1) comboRole.value = [{ id: 141, role: 'Super Admin' }];
  ...
  // Level Id 4 = Pembina
  else if (levelId == 4) comboRole.value = [{ id: 140, role: 'Approver' }, { id: 142, role: 'Monitoring' }, { id: 143, role: 'Input' }];
  // Level Id 5 = Pusat
  else if (levelId == 5) comboRole.value = [{ id: 141, role: 'Super Admin' }, { id: 142, role: 'Monitoring' }];

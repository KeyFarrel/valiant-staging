...
describe('LamanUtama.vue', () => {
  ...
  // it("is fetching getTotalDaya", async () => {
  //   const getTotalDayaSpy = jest.spyOn(wrapper.vm, "getTotalDaya");
  //   await wrapper.vm.getTotalDaya();
  //   expect(getTotalDayaSpy).toHaveBeenCalled();
  // });
  // it("is fetching getChartDaya", async () => {
  //   const getChartDayaSpy = jest.spyOn(wrapper.vm, "getChartDaya");
  //   await wrapper.vm.getChartDaya();
  //   expect(getChartDayaSpy).toHaveBeenCalled();
  // });
  it("is fetching getChartKategori", async () => {
    const getChartKategoriSpy = jest.spyOn(wrapper.vm, "getChartKategori");
    await wrapper.vm.getChartKategori();
    expect(getChartKategoriSpy).toHaveBeenCalled();
  });
});
